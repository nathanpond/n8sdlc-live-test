...
3. The storage file format is versioned JSON — never break reading an older file. — **test-enforced** (fixture tests read every prior on-disk format version; guard story #12, M1 — moved from M0 because the format is created by #6)
